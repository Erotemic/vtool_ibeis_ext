...
if __name__ == '__main__':
    ...
    if 0:
        setupkw['entry_points'] = {
            ...
            'console_scripts': [
                ...
                'vtool_ibeis_ext = vtool_ibeis_ext.__main__:main'
            ]
        }
    ...
    setupkw['extras_require'] = {
        ...
        'headless': parse_requirements('requirements/headless.txt'),  # vtool_ibeis_ext: +UNCOMMENT_IF(cv2)
        'graphics': parse_requirements('requirements/graphics.txt'),  # vtool_ibeis_ext: +UNCOMMENT_IF(cv2)
        # Strict versions
        'headless-strict': parse_requirements('requirements/headless.txt', versions='strict'),  # vtool_ibeis_ext: +UNCOMMENT_IF(cv2)
        'graphics-strict': parse_requirements('requirements/graphics.txt', versions='strict'),  # vtool_ibeis_ext: +UNCOMMENT_IF(cv2)
