...
Notes:
    ...
    rm -rf ~/code/vtool_ibeis_ext/docs/source/auto
    cd ~/code/vtool_ibeis_ext/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/vtool_ibeis_ext/docs/source/auto ~/code/vtool_ibeis_ext/vtool_ibeis_ext
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/vtool-ibeis-ext/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: vtool_ibeis_ext
            Set the Repository URL: https://github.com/Erotemic/vtool_ibeis_ext

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/vtool-ibeis-ext/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/vtool_ibeis_ext/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/vtool-ibeis-ext/versions/
"""
#
...
copyright = '2025, Jon Crall Avi Weinstock'
author = 'Jon Crall Avi Weinstock'
modname = 'vtool_ibeis_ext'

repo_dpath = dirname(dirname(dirname(__file__)))
mod_dpath = join(repo_dpath, 'vtool_ibeis_ext')
...
latex_documents = [
    (master_doc, 'vtool_ibeis_ext.tex', 'vtool_ibeis_ext Documentation',
     'Jon Crall Avi Weinstock', 'manual'),
]
